...
public class ServletRF8 extends ServletTemplate {
	// -----------------------------------------------------------------
	// Metodos
	// -----------------------------------------------------------------
	...
	public void escribirContenido( HttpServletRequest request, HttpServletResponse response ) throws IOException
	{
		...
		if(h==null){
			...
			out.println("<option> Pagar cuota </option>");
			out.println("<option> Pagar cuota extraordinaria </option>");
			out.println("                                            	</select>");
			out.println("           								</div>");
			out.println("                						<div class=\"form-group\">");
		...
		else
		{
			...
			ArrayList<OperacionPrestamo> r=BancAndes.getInstance().registrarOperacionSobrePrestamo(id,accion);
			out.println("				<section id=\"intro\" class=\"container\">");
			out.println("					<div class=\"panel-body\">");
			out.println("					<div class=\"row\">");
			out.println("                <div class=\"col-lg-12\">");
			...
			for(int i=0;i<r.size();i++)
			{
				...
				out.println("                                            <th>"+r.get(i).getIdPrestamo()+"</th>  ");
